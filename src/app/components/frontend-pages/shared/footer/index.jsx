            ...
            <Container maxWidth="lg" sx={{
                ...
                <Grid container spacing={3} justifyContent="space-between" mb={7}>
                    ...
                    <Grid item xs={6} sm={6} lg={2}>
                        <Typography fontSize="17px" fontWeight="600" mb='22px'>Siga-nos</Typography>

                        <Stack direction="row" gap="20px">
                            <Tooltip title="Facebook">
                                <Link href="https://v3l0z.com.br">
                ...
                <Box py="40px" useflexgap="true" flexWrap="wrap" display="flex" justifyContent="space-between">
                    <Stack direction="row" gap={1} alignItems="center">
                        ...
                        <Typography variant="body1" fontSize="15px">Todos os direitos reservados. </Typography>
                    </Stack>
                    <Typography variant="body1" fontSize="15px">Desenvolvido por <Typography component={Link} color="primary.main" href="https://v3l0z.com.br">v3l0z</Typography>.</Typography>
                </Box>
            </Container >
        </>
    );
